    ...
    <div className="min-h-screen bg-bg-base flex flex-col items-center justify-center px-6">
      <div className="mb-8 text-center">
        <h1 className="text-2xl font-sans font-semibold text-text-primary">
          Welcome back to Deal<span className="text-accent-light">Lens</span>
        </h1>
        <p className="text-sm text-text-muted mt-2">Log in to manage your deal flow</p>
      </div>
      ...
      <Link to="/" className="mt-8 text-xs font-mono text-text-faint hover:text-text-muted transition-colors">
        ← Back to Home
      </Link>
    </div>
  );
